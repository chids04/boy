...
// need a hook that catches all writes to TMA and checks whethere a pending tima
// reset is about to occur so that we ensure TMA is set before it copied to TIMA
//
