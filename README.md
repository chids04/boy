...
in the .zed folder there are tasks to run, debug and test the emulator, they work in the zed ide but can easily but typed into command line if u use something else
